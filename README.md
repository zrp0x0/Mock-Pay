...
* 말로만 듣던 기술들을 직접 사용해봐서 좋았다.
* 기술들도 단순히 가져다가 쓰는 것이 아니라 여러 시나리오를 생각해보고 심지어는 그 기술에 문제가 생길 수도 있다는 것을 항상 염두해야될 것 같다.
* 대학 수업 시간에 세상에 안전한(No Security 말고, 서버 다운 같은) 시스템은 존재하지 않고, 그에 맞게 시스템을 설계해야한다는 것을 배울 수 있어서 좋았다.
...
* 실제로 성능적인 부분과 모니터링 할 수 있는 기술들을 공부하고 싶다.
